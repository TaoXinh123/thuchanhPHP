<?php
    ...
    if(isset($_POST['btn_goi'])){
        ...
        //hàm explode là một hàm để tách một mangr thành một chuổi 
        $n= count($mang_so);
        for($i=0; $i<$n; $i++){
            $ket_qua += $mang_so[$i];
        }
...
<body>
    <form method="POST" action="nhap_mang.php">
        <table>
            <thead>
                <tr>
            ...
            <tbody>
                ...
                <tr>
                    <td>Tổng dãy số:</td>
                    <td><input type="text" name="kq" disabled="disabled" value="<?php echo $ket_qua; ?>"></td>
                </tr>
            </tbody>
        </table>
    </form>
